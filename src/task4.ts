...
class OrderManager {
    ...
    updateOrderStatus(orderId: number, newStatus: "Pending" | "Delivered" | "Cancelled"): void {
...
if (product1) cart.addProduct(product1, 2);
if (product2) cart.addProduct(product2, 1);
if (product5) cart.addProduct(product5, 1);
